...
public class DrawHelper
{
    ...
    private void DrawTrianglesHelper<T>(T[] vertices, BlendState blendMode, int? count) where T : struct, IVertexType
    {
        ...
        if (count > vertices.Length / 3)
            throw new ArgumentException("Count must be less than or equal to vertices length divided by 4");
    ...
    public void DrawTriangles<T>(T[] vertices, Effect effect, BlendState blendMode, int? count = null)
    ...
    public void DrawTriangles<T>(T[] vertices, IEffect effect, BlendState blendMode, int? count = null)
        where T : struct, IVertexType
    {
        effect.Apply();
        DrawTrianglesHelper(vertices, blendMode, count);
    ...
    public void DrawQuads<T>(T[] vertices, Effect effect, BlendState blendMode, int? count = null)
        where T : struct, IVertexType
    {
        effect.CurrentTechnique.Passes[0].Apply();
    ...
    public void DrawQuads<T>(T[] vertices, IEffect effect, BlendState blendMode, int? count = null)
        where T : struct, IVertexType
    {
        effect.Apply();
        DrawQuadsHelper(vertices, blendMode, count);
